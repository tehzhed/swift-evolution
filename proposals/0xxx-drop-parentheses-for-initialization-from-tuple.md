...
This proposal suggests a syntax change that therefore breaks compatibility with existing code. Accounting for this syntax update is straightforward and simply consists of getting rid of opening and closing brackets when unpacking a tuple. Therefore this:
```swift
let (name, surname) = ("John", "Doe")
```
